...
var generatedResources = []func() resource.Resource{
	...
	func() resource.Resource {
		return &actionApiResource{name: "admin_ai_quality_evaluate_action", path: "/admin/ai-quality/evaluate", pathTemplate: "", method: "POST", readPath: "", desc: "Endpoint d'administration (Bearer requis) — mutation POST exacte `/admin/ai-quality/evaluate` (resource action Terraform).", hasJSONBody: true, bodyRequired: false, allowAdditionalBodyFields: true}
	},
	func() resource.Resource {
	...
	func() resource.Resource {
		return &actionApiResource{name: "admin_hierarchy_nodes_item_id_mutation", path: "", pathTemplate: "/admin/hierarchy/nodes/{item_id}", method: "DELETE", readPath: "/admin/hierarchy", desc: "Endpoint d'administration (Bearer requis) — mutation DELETE exacte `/admin/hierarchy/nodes/{item_id}` (resource action Terraform).", hasJSONBody: true, bodyRequired: false, allowAdditionalBodyFields: true}
	},
	func() resource.Resource {
