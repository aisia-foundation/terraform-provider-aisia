...
var generatedResources = []func() resource.Resource{
	...
	func() resource.Resource {
		return &actionApiResource{name: "admin_blog_posts", path: "/admin/blog/posts", pathTemplate: "", method: "POST", readPath: "/admin/blog/posts", desc: "Endpoint d'administration (Bearer requis) — mutation POST exacte `/admin/blog/posts` (resource action Terraform).", hasJSONBody: true, bodyRequired: false, allowAdditionalBodyFields: false, bodyFields: []string{"content_md", "excerpt", "id", "slug", "tags", "title"}, typedAttrs: []apiAttr{{Name: "request_id", TFType: "string", WireName: "id", Required: false, Sensitive: false, JSONEncoded: false, Desc: "champ id"}, {Name: "slug", TFType: "string", Required: false, Sensitive: false, JSONEncoded: false, Desc: "champ slug"}, {Name: "title", TFType: "string", Required: false, Sensitive: false, JSONEncoded: false, Desc: "champ title"}, {Name: "content_md", TFType: "string", Required: false, Sensitive: false, JSONEncoded: false, Desc: "champ content_md"}, {Name: "excerpt", TFType: "string", Required: false, Sensitive: false, JSONEncoded: false, Desc: "champ excerpt"}, {Name: "tags", TFType: "list", Required: false, Sensitive: false, JSONEncoded: false, Desc: "champ tags"}}}
	},
	func() resource.Resource {
	...
	func() resource.Resource {
		return &actionApiResource{name: "admin_connectors_catalog_import_openapi_action", path: "/admin/connectors-catalog/import-openapi", pathTemplate: "", method: "POST", readPath: "/admin/connectors-catalog", desc: "Endpoint d'administration (Bearer requis) — mutation POST exacte `/admin/connectors-catalog/import-openapi` (resource action Terraform).", hasJSONBody: false, bodyRequired: false, allowAdditionalBodyFields: false}
	},
	func() resource.Resource {
	...
	func() resource.Resource {
		return &actionApiResource{name: "admin_oidc_providers", path: "/admin/oidc-providers", pathTemplate: "", method: "POST", readPath: "/admin/oidc-providers", desc: "Endpoint d'administration (Bearer requis) — mutation POST exacte `/admin/oidc-providers` (resource action Terraform).", hasJSONBody: true, bodyRequired: true, allowAdditionalBodyFields: true, bodyFields: []string{"config", "enabled", "provider_id"}, typedAttrs: []apiAttr{{Name: "provider_id", TFType: "string", Required: false, Sensitive: false, JSONEncoded: false, Desc: "champ provider_id"}, {Name: "enabled", TFType: "bool", Required: false, Sensitive: false, JSONEncoded: false, Desc: "champ enabled"}, {Name: "config", TFType: "string", Required: false, Sensitive: true, JSONEncoded: true, Desc: "champ config"}}, sensitiveFields: []string{"config"}}
	},
	func() resource.Resource {
