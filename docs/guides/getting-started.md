...
> **Runtime LIVE** : **v6.13.10** (2026-08-25) · **code monorepo v6.13.10** (tagué ; provider public @ v6.13.10 — module Google public 🔒 VCS UI).
...
2. **Version couplée** : provider `~> 6.13` aligné sur la plateforme **v6.13.10**.
