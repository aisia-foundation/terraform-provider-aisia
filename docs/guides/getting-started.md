...
> **Version LIVE** : **v6.12.28** (2026-07-14) — guide synchronisé avec le provider et les modules registry.
...
2. **Version couplée** : provider `~> 6.12` aligné sur la plateforme **v6.12.28**.
