...
> **Runtime LIVE** : **v6.12.95** (2026-08-18) · **code monorepo v6.12.96** (tagué ; provider public @ v6.12.95 — module Google public 🔒 VCS UI).
...
2. **Version couplée** : provider `~> 6.12` aligné sur la plateforme **v6.12.95**.
