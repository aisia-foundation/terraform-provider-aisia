...
> **Version LIVE** : **v6.12.83** (2026-08-09) — guide synchronisé avec le provider et les modules registry.
...
2. **Version couplée** : provider `~> 6.12` aligné sur la plateforme **v6.12.83**.
