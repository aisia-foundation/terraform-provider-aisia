...
> **Runtime LIVE** : **v6.13.12** (2026-09-16) · **code monorepo v6.13.15** (tagué ; provider public @ v6.13.12 — module Google public 🔒 VCS UI).
...
2. **Version couplée** : provider `~> 6.13` aligné sur la plateforme **v6.13.12**.
