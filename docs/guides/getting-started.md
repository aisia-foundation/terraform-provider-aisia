...
> **Runtime LIVE** : **v6.12.90** (2026-08-15) · **code monorepo v6.12.90** (tagué ; registry public encore v6.12.90).
...
2. **Version couplée** : provider `~> 6.12` aligné sur la plateforme **v6.12.90**.
