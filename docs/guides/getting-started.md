...
> **Runtime LIVE** : **v6.12.96** (2026-08-19) · **code monorepo v6.12.97** (tagué ; provider public @ v6.12.96 — module Google public 🔒 VCS UI).
...
2. **Version couplée** : provider `~> 6.12` aligné sur la plateforme **v6.12.96**.
