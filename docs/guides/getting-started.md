...
> **Runtime LIVE** : **v6.12.93** (2026-08-17) · **code monorepo v6.12.93** (tagué ; provider public @ v6.12.93 — module Google public 🔒 VCS UI).
...
2. **Version couplée** : provider `~> 6.12` aligné sur la plateforme **v6.12.93**.
