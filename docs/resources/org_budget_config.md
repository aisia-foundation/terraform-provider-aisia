...
page_title: "aisia_org_budget_config Resource - aisia"
subcategory: ""
description: |-
...
# aisia_org_budget_config (Resource)
...
```terraform
resource "aisia_org_budget_config" "main" {
  body = jsonencode({
...
> Ressource `resource` : `aisia_org_budget_config` — synchronisée avec l'OpenAPI AISIA.
