...
page_title: "aisia_admin_config_email_templates_config Resource - aisia"
subcategory: ""
description: |-
...
# aisia_admin_config_email_templates_config (Resource)
...
```terraform
resource "aisia_admin_config_email_templates_config" "main" {
  body = jsonencode({
...
> Ressource `resource` : `aisia_admin_config_email_templates_config` — synchronisée avec l'OpenAPI AISIA.
