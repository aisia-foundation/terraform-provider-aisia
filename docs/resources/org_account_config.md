...
page_title: "aisia_org_account_config Resource - aisia"
subcategory: ""
description: |-
...
# aisia_org_account_config (Resource)
...
```terraform
resource "aisia_org_account_config" "main" {
  body = jsonencode({
...
> Ressource `resource` : `aisia_org_account_config` — synchronisée avec l'OpenAPI AISIA.
