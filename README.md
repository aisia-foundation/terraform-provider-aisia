...
> **Prod live vérifiée** : **v6.12.91** (2026-08-16) · **code cible v6.12.92** 🟡 (tagué ; images/rolling non faits — LIVE reste v6.12.91) — chiffres : `project_facts.json` · régénéré par `09_publications.py`.
...
Provider **couplé à AISIA** : tag monorepo **v6.12.92** (fichier `VERSION`) · PROD LIVE documentaire **v6.12.91**.
