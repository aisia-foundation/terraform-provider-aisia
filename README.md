...
> **Prod live vérifiée** : **v6.12.95** (2026-08-18) · **code cible v6.12.96** 🟡 (tagué ; images/rolling non faits — LIVE reste v6.12.95) — chiffres : `project_facts.json` · régénéré par `09_publications.py`.
...
Provider **couplé à AISIA** : tag monorepo **v6.12.96** (fichier `VERSION`) · PROD LIVE documentaire **v6.12.95**.
