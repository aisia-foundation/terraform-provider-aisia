...
> **Prod live vérifiée** : **v6.12.45** (2026-07-16) — chiffres : `project_facts.json` · régénéré par `09_publications.py`.
...
Provider **couplé à AISIA** : `aisia 6.12.45` cible la plateforme **v6.12.45**.
