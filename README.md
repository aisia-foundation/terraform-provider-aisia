...
> **Prod live vérifiée** : **v6.12.26** (2026-07-13) — chiffres : `project_facts.json` · régénéré par `09_publications.py`.
...
Provider **couplé à AISIA** : `aisia 6.12.26` cible la plateforme **v6.12.26**.
