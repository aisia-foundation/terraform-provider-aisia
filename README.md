...
> **Prod LIVE PARTIAL** : **v6.13.15** (2026-09-16) — chiffres : `project_facts.json` · régénéré par `09_publications.py`.
...
Provider **couplé à AISIA** : tag monorepo **v6.13.15** (fichier `VERSION`) · PROD LIVE documentaire **v6.13.15**.
