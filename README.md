...
> **Prod LIVE PARTIAL** : **v6.12.93** (2026-08-17) — chiffres : `project_facts.json` · régénéré par `09_publications.py`.
...
Provider **couplé à AISIA** : tag monorepo **v6.12.93** (fichier `VERSION`) · PROD LIVE documentaire **v6.12.93**.
