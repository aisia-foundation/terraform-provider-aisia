...
> **Prod live vérifiée** : **v6.12.88** (2026-08-11) — chiffres : `project_facts.json` · régénéré par `09_publications.py`.
...
Provider **couplé à AISIA** : tag monorepo **v6.12.88** (fichier `VERSION`) · PROD LIVE documentaire **v6.12.88**.
