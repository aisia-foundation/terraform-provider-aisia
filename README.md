...
> **Prod live vérifiée** : **v6.12.81** (2026-08-05) — chiffres : `project_facts.json` · régénéré par `09_publications.py`.
...
Provider **couplé à AISIA** : `aisia 6.12.81` cible la plateforme **v6.12.81**.
